...
# parser.add_argument("--input_dir", default="/mnt/mycodes/reduction_train_combine", help="path to folder containing images")
parser.add_argument("--input_dir", default="data_prepare/reduction_train_combine", help="path to folder containing images")
...
parser.add_argument("--output_dir",  default="classify_20210414_n" ,help="where to put output files")
