...
# parser.add_argument("--input_dir", default="/mnt/mycodes/reduction_train_combine",
#                     help="path to folder containing images")
parser.add_argument("--input_dir", default="data_prepare/reduction_train_combine",
                    help="path to folder containing images")
parser.add_argument("--mode", default="train", choices=["train", "test", "export"])
# parser.add_argument("--output_dir", default="/mnt/mycodes/classify_20210413", help="where to put output files")
parser.add_argument("--output_dir", default="data_prepare/classify_20210414_2", help="where to put output files")
...
parser.add_argument("--reg_weight", type=float, default=0.01, help="weight on regularization term for generator gradient")
...
def conv(batch_input, out_channels, stride):
    with tf.variable_scope("conv"):
        ...
        conv = slim.conv2d(padded_input, out_channels, 4, stride=stride, padding="VALID",
                           weights_regularizer=slim.l2_regularizer(a.reg_weight), activation_fn=None,
...
def deconv(batch_input, out_channels):
    with tf.variable_scope("deconv"):
        ...
        conv = slim.conv2d_transpose(batch_input, out_channels, 4, stride=2, padding="SAME",
                                     weights_regularizer=slim.l2_regularizer(a.reg_weight), activation_fn=None,
                                     weights_initializer=tf.random_normal_initializer(0, 0.02))
        return conv
...
def save_images(fetches, step=None):
    ...
    image_dir2 = os.path.join(a.output_dir, "images", "outputs")
    ...
    for i, in_path in enumerate(fetches["paths"]):
        ...
        filename = name + ".jpg"
        out_path2 = os.path.join(image_dir, "outputs", filename)
